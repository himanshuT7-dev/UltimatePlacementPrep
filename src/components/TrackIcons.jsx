...
export function JavaIcon({ size = 20, style = {} }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style} aria-label="Java">
...
/* ── SQL / Database Icon ── */
export function SQLIcon({ size = 20, style = {} }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style} aria-label="SQL">
...
export function JSIcon({ size = 20, style = {} }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style} aria-label="JavaScript">
...
export function ReactIcon({ size = 20, style = {} }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style} aria-label="React">
...
export function CommIcon({ size = 20, style = {} }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style} aria-label="Communication">
...
export function UPPLogo({ size = 32, style = {} }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none" style={style} aria-label="Ultimate Placement Prep">
      {/* Outer ring */}
...
export function TrackIcon({ trackId, size = 18, style = {} }) {
